...
﻿    public unsafe partial class padded_string : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        /// </summary>
        public padded_string(IntPtr handle) : base(ownsHandle: true) => SetHandle(handle);
        ...
        protected override bool ReleaseHandle() => padded_string_Dispose(Handle);

        [DllImport("simdjson.dll", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool padded_string_Dispose(IntPtr target);
        #endregion
    }
...
﻿    public unsafe partial class ParsedJson : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        /// </summary>
        public ParsedJson(IntPtr handle) : base(ownsHandle: true) => SetHandle(handle);
        ...
        #region ReleaseHandle
        protected override bool ReleaseHandle() => ParsedJson_Dispose(Handle);

        [DllImport("simdjson.dll", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool ParsedJson_Dispose(IntPtr target);
        #endregion
    }
...
﻿    public unsafe partial class InvalidJSON : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        /// </summary>
        public InvalidJSON(IntPtr handle) : base(ownsHandle: true) => SetHandle(handle);
        ...
        #region ReleaseHandle
        protected override bool ReleaseHandle() => InvalidJSON_Dispose(Handle);

        [DllImport("simdjson.dll", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool InvalidJSON_Dispose(IntPtr target);
        #endregion
    }
...
﻿    public unsafe partial class iterator : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        /// </summary>
        public iterator(IntPtr handle) : base(ownsHandle: true) => SetHandle(handle);
        ...
        #region ReleaseHandle
        protected override bool ReleaseHandle() => iterator_Dispose(Handle);

        [DllImport("simdjson.dll", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool iterator_Dispose(IntPtr target);
        #endregion
    }
...
﻿    public unsafe partial class scopeindex_t : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        /// </summary>
        public scopeindex_t(IntPtr handle) : base(ownsHandle: true) => SetHandle(handle);
        ...
        #region ReleaseHandle
        protected override bool ReleaseHandle() => scopeindex_t_Dispose(Handle);

        [DllImport("simdjson.dll", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool scopeindex_t_Dispose(IntPtr target);
        #endregion
    }
