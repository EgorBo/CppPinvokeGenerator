...
﻿    public unsafe partial class SimdInputN : SafeHandleZeroOrMinusOneIsInvalid
    {
        #region Handle
        /// <summary>
        /// Pointer to the underlying native object
        ...
        /// <summary>
        /// Create SimdInputN from a native pointer
        /// if letGcDeleteNativeObject is false GC won't release the underlying object (use ONLY if you know it will be handled by some other native object)
        /// </summary>
        public SimdInputN(IntPtr handle, bool letGcDeleteNativeObject) : base(letGcDeleteNativeObject) => SetHandle(handle);
        #endregion
        ...
        protected override bool ReleaseHandle()
        {
            simd_input__delete(Handle);
            return true;
        }

        [DllImport(SimdJsonN.NativeLib, CallingConvention = CallingConvention.Cdecl)]
        private static extern void simd_input__delete(IntPtr target);
        #endregion
    }

﻿    public unsafe partial class Utf8CheckingStateN : SafeHandleZeroOrMinusOneIsInvalid
    {
        #region Handle
        /// <summary>
        /// Pointer to the underlying native object
        ...
        /// <summary>
        /// Create Utf8CheckingStateN from a native pointer
        /// if letGcDeleteNativeObject is false GC won't release the underlying object (use ONLY if you know it will be handled by some other native object)
        /// </summary>
        public Utf8CheckingStateN(IntPtr handle, bool letGcDeleteNativeObject) : base(letGcDeleteNativeObject) => SetHandle(handle);
        #endregion
        ...
        protected override bool ReleaseHandle()
        {
            utf8_checking_state__delete(Handle);
            return true;
        }

        [DllImport(SimdJsonN.NativeLib, CallingConvention = CallingConvention.Cdecl)]
        private static extern void utf8_checking_state__delete(IntPtr target);
        #endregion
    }
...
﻿    public unsafe static partial class SimdJsonN
    {
        ...
        public static UInt64 ComputeQuoteMask(UInt64 quote_bits) => _compute_quote_mask_u(quote_bits);
        ...
        /// </summary>
        public static ParseStringHelperN FindBsBitsAndQuoteBits(Byte* src, Byte* dst) => new ParseStringHelperN(_find_bs_bits_and_quote_bits_uu(src, dst), false);
        ...
        [DllImport(SimdJsonN.NativeLib, CallingConvention = CallingConvention.Cdecl)]
        private static extern UInt64 _compute_quote_mask_u(UInt64 quote_bits);
